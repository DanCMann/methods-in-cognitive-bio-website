...
# Collaboration and reproducible reserach
...
- R projects store settings 
        - do you want to save your environment when closing?
        - do you want to start a session with a clean environment?
...
![*Zipping a file in Windows 10.*](../img/zipping_img.PNG)
...
![*notFinal.doc from the web comic phdcomics*](../img/phd101212s.gif)
...
![*Git branching. Image from Puia Zahedi*](../img/git.jpg)
...
- information on the R version, any packages used, the operating system (mac, windows 10, etc.)
        + you can easily get this information by using the function `sessionInfo()`
...
- **R for Data Science** by Hadley Wickham & Garret Grolemund: [https://r4ds.had.co.nz](https://r4ds.had.co.nz)
- **Advanced R** by Hadley Wickham: [https://adv-r.hadley.nz](https://adv-r.hadley.nz)
        

Websites for Stats: 

- **Applied Statistics with R** by David Dalpiaz:  [https://daviddalpiaz.github.io/appliedstats/](https://daviddalpiaz.github.io/appliedstats/)
- Visualizing Statistics, University of British Columbia: [https://www.zoology.ubc.ca/~whitlock/Kingfisher/KFhomepage.htm](https://www.zoology.ubc.ca/~whitlock/Kingfisher/KFhomepage.htm)
- **Introduction to Statistics using R** by Tom Booth, Anastasia Ushakova, & Milan Valasek: [https://bookdown.org/animestina/intro_stats_rms/](https://bookdown.org/animestina/intro_stats_rms/)
